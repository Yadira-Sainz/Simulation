 ...
 */
package handson5_multiagent.regression.mlr;
 ...
 * @author yadira
 */
public class MLRServiceAgent extends Agent {
    protected void setup() {
        System.out.println("MLR-service " + getLocalName() + " started.");
        ...
        addBehaviour(new MLRServiceAgentBehaviour());

    }

    private class MLRServiceAgentBehaviour extends Behaviour {

        @Override
        public void action() {
            //System.out.println("Performing Action in MLRServiceAgent");
            ACLMessage msg = receive();
            if (msg != null) {
                //System.out.println("Recibido: desde el agente MLR: " + msg.getContent());
                ...
                //System.out.println("BETAS DESDE MLRServiceAgent:");
