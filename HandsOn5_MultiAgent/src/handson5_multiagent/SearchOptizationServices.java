 ...
 * @author yadira
 */
public class SearchOptizationServices extends Agent {

    @Override
    protected void setup() {

        System.out.println("SearchOptizationServices " + getLocalName() + " started.");

        // Crear la descripción del servicio que ofrece este agente
        ServiceDescription sd = new ServiceDescription();
        sd.setType("search-optimization-services");
        ...
        addBehaviour(new SearchOptizationServicesBehaviour());

    }

    private class SearchOptizationServicesBehaviour extends Behaviour {
        ...
        public void action() {
            ...
            if (msg != null) {
                ...
                //System.out.println("Recived msg in SearchOptimizationServices:" + msg.getContent());
                msgToOptSercive.setContent(msg.getContent());
                // Crear el mensaje
                DFAgentDescription[] result1 = Utils.searchAgent("optimization-service", myAgent);
                ...
                for (DFAgentDescription agent : result1) {
                    ...
                    if (reply != null) {
                        //System.out.println("Betas Opt--> " + reply.getContent());
                ...
                System.out.println("Best agent of optimization is " + bestTechnique + " betas: " + betas);
